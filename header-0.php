...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header container-fluid">
		<div class="row">
			...
			<div class="site-branding col-md-5 cr-fondo">
				<?php
				if ( has_custom_logo() ) {
				the_custom_logo(); }
				else { 
			...
			<nav id="site-navigation" class="main-navigation col-md-7 cr-fondo pt-4">
				<button class="menu-toggle float-left" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'climarisk' ); ?></button>
				<?php
				wp_nav_menu(
					array(
